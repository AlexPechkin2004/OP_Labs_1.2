...
void CreatePairOfAccounts(int, CurrentAccount**&, DepositAccount**&);
void BankOperations(int, CurrentAccount**&, DepositAccount**&);
void AccountsOutput(int, CurrentAccount**&, DepositAccount**&);
Date getSystemDate();
