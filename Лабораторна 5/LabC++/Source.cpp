...
void CreatePairOfAccounts(int size, vector<CurrentAccount>& currents, vector<DepositAccount>& deposits) {
...
void BankOperations(int size, vector<CurrentAccount>& currents, vector<DepositAccount>& deposits) {
...
void AccountsOutput(int size, vector<CurrentAccount>& currents, vector<DepositAccount>& deposits) {
	cout << endl;
	for (int i = 0; i < size; i++)
	{
